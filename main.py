        ...
        if user.User.check_username(username):
            while count < 3:
                ...
                if create_user.check_password():
                    ...
                    # log_in_2 = create_user.signIn(dirName)
                    break
                ...
                if msg3 == '1':
                    ...
                    if msg5 == '1':
                        ...
                        if msg4 == '0':
                            ...
                            read_file = file_handler.FileHandler(dirName, 'Draft')
                            read_draft = read_file.read_file()
                            for row in read_draft:
                                if row['id'] == msg4:
                    ...
                    if msg10.lower() == 'y':
                        ...
                        if msg4 == '0':
                            ...
                            read_file = file_handler.FileHandler(dirName, 'Sent')
                            read_sent = read_file.read_file()
                            for row in read_sent:
                                if row['id'] == msg4:
